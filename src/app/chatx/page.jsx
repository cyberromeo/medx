        ...
        <div className="flex items-center justify-center h-screen">
          <div className="flex flex-col items-center gap-3">
            <div className="relative">
              <div className="w-12 h-12 rounded-full bg-primary-soft animate-ping absolute" />
  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="container mx-auto px-4 sm:px-6 pt-20 pb-10">
        <section className="panel rounded-3xl overflow-hidden max-w-4xl mx-auto flex flex-col h-[78vh]">
