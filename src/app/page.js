        ...
        <div className="container mx-auto max-w-5xl text-center">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-bold leading-tight mb-8 tracking-tight">
              Master the <br />
              <span className="text-gradient">Medical Arts</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/login" className="bg-white text-black px-8 py-4 rounded-full font-bold text-lg hover:scale-105 active:scale-95 transition-all flex items-center gap-2 w-full sm:w-auto justify-center">
                Start Learning
                <ArrowRight size={20} />
              </Link>
              <a href="#features" className="px-8 py-4 rounded-full font-bold text-lg text-white border border-white/10 hover:bg-white/5 hover:border-primary/30 transition-all w-full sm:w-auto ring-1 ring-white/10 hover:ring-primary/30">
                View Syllabus
              </a>
            </div>
          </motion.div>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="md:col-span-2 glass-panel p-10 rounded-3xl relative overflow-hidden group"
            >
